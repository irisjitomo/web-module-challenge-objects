...
export const burger = {
  ...
  discount: function(category) {
    switch(true) {
      case (category == 'teacher' || category == 'student'):
...
reviews.push({name: 'Iris', rating: 7, feeback: 'example feedback'})
...
function getLastReview(arr) {
  /*Your code here*/
  let lastObject = arr[arr.length - 1]
  return (`${lastObject.name} gave the restaurant a ${lastObject.rating} star review, and their feedback was: ${lastObject.feedback}`)
} 
